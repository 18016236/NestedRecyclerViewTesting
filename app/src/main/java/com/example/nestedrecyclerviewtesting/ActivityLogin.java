            ...
            public void onComplete( Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    if (user.isEmailVerified()){
                        ...
                        Toast.makeText(ActivityLogin.this, "Check your email to verify your account! ", Toast.LENGTH_SHORT).show();
                    }

                }else{
                    Toast.makeText(ActivityLogin.this, "Failed to login! Please check your credentials", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
