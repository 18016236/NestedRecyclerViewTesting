...
public class CherryPlumDetails extends AppCompatActivity {
    ImageView ivArrowBack;

    TextView tvCherryPlumTomatoesPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cherry_plum_details);
        ...
        tvCherryPlumTomatoesPrice = findViewById(R.id.CherryPlumTomatoesPrice);
        ...
        docRef = colRef.document("CherryPlumTomatoesPrice");
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if (value !=null && value.exists()){
                    ...
                    tvCherryPlumTomatoesPrice.setText(text);
                }
            }
        });
    }
